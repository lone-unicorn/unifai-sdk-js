...
import { Signer, EtherSigner, WagmiSigner, SolanaSigner, SendConfig } from '../types';
...
export class TransactionAPI extends BaseTransactionAPI {
    ...
    constructor(config: APIConfig) {
        ...
        this.solanaHandler = new SolanaHandler(this.rateLimiter, this.maxPollTimes, this.pollInterval);
...
export { TransactionAPI as default };
